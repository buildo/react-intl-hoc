...
var FormattedNumber = (function (_React$Component) {
  ...
  _inherits(FormattedNumber, _React$Component);

  FormattedNumber.prototype.render = function render() {
    return _react2['default'].createElement(_IntlComponentWrapper2['default'], _extends({}, this.props, { intlComponent: _reactIntl.FormattedNumber }));
  };
